...
function paymentContent(payment) {
    return `<tr class="border-b bg-gray-50 border-neutral-500 dark:border-white/10">
    <td class="whitespace-nowrap font-semibold  px-6 py-4">${payment.gym_name}</td>
    <td class="whitespace-nowrap font-semibold  px-6 py-4">${payment.from_date}</td>
    <td class="whitespace-nowrap font-semibold  px-6 py-4">${payment.to_date}</td>
